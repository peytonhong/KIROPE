...
def gaussian_position_encoding(joint_states, num_features=10000, s=0.1):
    """
    ...
    position_encoding = np.zeros((len(joint_states), num_features))
    for i in range(len(joint_states)):
        ...
        position_encoding[i][:] = z.flatten()
    return position_encoding # [7, 10000]